...
\response{We thank the reviewer for spotting this critical issue. The flawless performance of FL-GNN and FGAT was not due to test-set leakage, but rather an artifact of our synthetic dataset generator. The generated feature clusters were originally overly separated, making the classification task trivially easy for models lacking strong rule-pruning regularization. We have completely overhauled our graph construction protocol (Section 5.1) to introduce realistic feature overlap and noise. All experiments were re-run on this much harder, realistic data. As shown in the updated Table 3, the perfect scores have vanished, and the baseline results are now realistic.}
