...
Furthermore, we agree that empirical validation of these choices is necessary. We have added a new quantitative experiment (Section 4.9: Sensitivity to Graph Construction, Table 8) that evaluates FC-GNN across varying $k$-NN feature-similarity edge densities. The results demonstrate that while the Mondrian coverage guarantee remains perfectly robust across all densities, our default choice of $k=5$ provides the optimal sweet spot for prediction-set efficiency (APSS).}
